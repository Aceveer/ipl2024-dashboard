...
const ScoreCard: React.FC<ScoreCardProps> = ({
    ...
    return (
        <div className="w-full flex justify-center mt-6 flex-wrap">
            <div className="bg-white shadow-lg rounded-xl p-4 flex flex-row w-3/4 md:w-3/4 lg:w-3/4 text-center border border-gray-300">
                
                {/* Left Column - Runs & Overs */}
                <div className="flex flex-col w-1/3 justify-center items-center border-r">
                    <div className="text-3xl font-bold">{runs} - {wickets}</div>
                    <div className="text-sm text-gray-600">{overs} Overs</div>
                    <div className="text-sm text-gray-600 font-bold">{desc}</div>
                </div>
